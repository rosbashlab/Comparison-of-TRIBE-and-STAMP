...
bedtools slop -i $final_name"_coords_13_not_in_enzyme_unique.bedgraph" -l 25 -r 25  -g /Users/kate/scripts/dm6_chrom_sizes.bed > $final_name"_sub_1percent_13_25slop.bed"
awk 'NR==1 ||  (NR>1 && ($3 - $2 > 10))' $final_name"_sub_1percent_13_25slop.bed" > $final_name"_25slop.check.bed"


#slop with 50bp added on
bedtools slop -i $final_name"_coords_13_not_in_enzyme_unique.bedgraph" -l 50 -r 50  -g /Users/kate/scripts/dm6_chrom_sizes.bed  > $final_name"_sub_1percent_13_50slop.bed"
awk 'NR==1 ||  (NR>1 && ($3 - $2 > 10))' $final_name"_sub_1percent_13_50slop.bed" > $final_name"_50slop.check.bed"

#slop with 100bp added on
bedtools slop -i $final_name"_coords_13_not_in_enzyme_unique.bedgraph" -l 100 -r 100  -g /Users/kate/scripts/dm6_chrom_sizes.bed  > $final_name"_sub_1percent_13_100slop.bed"
awk 'NR==1 ||  (NR>1 && ($3 - $2 > 10))' $final_name"_sub_1percent_13_100slop.bed" > $final_name"_100slop.check.bed"

#slop with 10bp added on
bedtools slop -i $final_name"_coords_13_not_in_enzyme_unique.bedgraph" -l 10 -r 10  -g /Users/kate/scripts/dm6_chrom_sizes.bed  > $final_name"_sub_1percent_13_10slop.bed"
